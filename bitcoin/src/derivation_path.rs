...
use gyu_model::amount::AmountError;
use serde::Serialize;
...
impl BitcoinAmount {
    ...
    pub fn from_cbtc(cbtc_value: i64) -> Result<Self, AmountError> {
        let satoshis = cbtc_value * 10_i64.pow(Denomination::CentBit.precision());
